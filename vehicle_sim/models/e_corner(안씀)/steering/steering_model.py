...
class SteeringModel:
    """Corner steering actuator model."""
    ...
    def __init__(
        ...
        self.params.max_angle_pos = self._get_angle_limit(steering_param, side_key, "max_angle_pos")
        self.params.max_angle_neg = self._get_angle_limit(steering_param, side_key, "max_angle_neg")
    ...
    @staticmethod
    def _get_angle_limit(steering_param: Dict, side_key: Optional[str], key: str) -> float:
